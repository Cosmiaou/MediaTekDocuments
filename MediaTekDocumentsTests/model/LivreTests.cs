...
namespace MediaTekDocuments.model.Tests
{
    ...
    public class LivreTests
    {
        ...
        private const string ISBN = "978-xxxxxx";
        private const string auteur = "test";
        private const string collection = "collection";
        private readonly Livre doc = new Livre(id, titre, image, ISBN, auteur, collection, idGenre, genre, idPublic, lePublic, idRayon, rayon);
        ...
        public void LivreTest()
        {
            ...
            Assert.AreEqual(ISBN, doc.Isbn);
            Assert.AreEqual(auteur, doc.Auteur);
            Assert.AreEqual(collection, doc.Collection);
